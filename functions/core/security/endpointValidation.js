...
function isPrivateHost(host) {
  ...
  if (/^127\./.test(value) || /^10\./.test(value) || /^192\.168\./.test(value) || /^169\.254\./.test(value) || /^0\./.test(value)) return true;
  if (/^172\.(1[6-9]|2\d|3[0-1])\./.test(value) || value === '::1' || /^f[cd][0-9a-f:]*$/i.test(value) || /^fe80:/i.test(value)) return true;
  return false;
}
